...
public class GameGUI extends JFrame {
    ...
    private void addPage1() {
        new Thread(() -> welcome.playSound("C:\\Users\\user\\OneDrive\\سطح المكتب\\projectnew\\intro-logo-13488.wav")).start();
        ...
        background.setIcon(new ImageIcon("IMG_1077_resized.jpg"));
    ...
    private void addPage2() {
        ...
        connectButton.addActionListener(e -> {
            ...
            if (!(playerName == null || playerName.isEmpty()) && playerName.matches("[a-zA-Z\\u0600-\\u06FF]+")) {
                ...
                new Thread(() -> welcome.playSound("C:\\Users\\user\\OneDrive\\سطح المكتب\\projectnew\\n" + //
                                        "ew-notification-7-210334.wav")).start();
    ...
    private void addPage3() {
        ...
        playerListArea.setFont(new Font("Arial", Font.PLAIN, 14));
    ...
    private void addPage4() {
        ...
        waitingListArea.setFont(new Font("Arial", Font.PLAIN, 14));
        ...
        JLabel background = new JLabel("background");
        background.setIcon(new ImageIcon("IMG_1077_resized.jpg"));
        background.setBounds(0, -21, 573, 512);
 ...
 // Page 5: Game Room with Player Scores   
    private void addPage5() {
        ...
        scoreLabel.setFont(new Font("Arabic Typesetting", Font.BOLD, 20));  
        scoreLabel.setBounds(460, 5, 55, 30);
        ...
        scoreArea.setBounds(398, 18, 100, 86);
        scoreArea.setEditable(false);
        scoreArea.setFont(new Font("Arabic Typesetting", Font.BOLD, 18));
 ...
 // Page 6: End Game with Winner Player   
    private void addPage6() {
        ...
        //page6.setBackground(new Color(255, 255, 255));
        ...
        //winnerArea.setBackground(new Color(0, 0, 0, 0));
        winnerArea.setOpaque(false); 
        winnerArea.setBounds(126, 227, 242, 67);
        winnerArea.setFont(new Font("Arabic Typesetting", Font.BOLD | Font.ITALIC, 20));
    ...
    private void handleServerMessage(String message) {
        ...
        if (message.equals("Room is full. You cannot join the game.")) {
            ...
            new Thread(() -> SoundPlayer.playSound("C:\\Users\\user\\OneDrive\\سطح المكتب\\projectnew\\success-fanfare-trumpets-6185.wav")).start();
            ...
            new Thread(() -> Correct.playSound("C:\\Users\\user\\OneDrive\\سطح المكتب\\projectnew\\correct-6033.wav")).start();
        JOptionPane.showMessageDialog(this, "مرادف صالح!", "Valid", JOptionPane.INFORMATION_MESSAGE);
            ...
            new Thread(() -> wrong.playSound("C:\\Users\\user\\OneDrive\\سطح المكتب\\projectnew\\cartoon-trombone-sound-effect-241387.wav")).start();
