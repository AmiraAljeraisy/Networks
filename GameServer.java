...
public class GameServer {
    ...
    private static void initializeWords() {
        ...
        wordSynonyms.put("سعيد", Arrays.asList("مرح", "راضي", "مبهج", "فرح"));
        wordSynonyms.put("حزين", Arrays.asList("بائس", "حزين", "مكتئب", "تعيس"));
        wordSynonyms.put("سريع", Arrays.asList("عجول", "مسرع", "متسرع", "عاجل"));
        wordSynonyms.put("بطيء", Arrays.asList("خامل", "سلحفاة", "متأني", "كسول"));
        // Add more synonym 
    }
